...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.sintoma-card, .capitulo-card, .beneficio-card');
...
// Adicionar classe ativa no header quando rolar a página
window.addEventListener('scroll', () => {
